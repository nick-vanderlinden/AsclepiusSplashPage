...
class Trail {
  ...
  load(data) {
    ...
    if (data.particles !== undefined) {
      this.particles = (0,engine_root_window_.deepExtend)({}, data.particles);
    }
...
class TrailMaker extends engine_root_window_.ExternalInteractorBase {
  ...
  isEnabled(particle) {
    ...
    return mouse.clicking && mouse.inside && !!mouse.position && (0,engine_root_window_.isInArray)(trailMode, events.onClick.mode) || mouse.inside && !!mouse.position && (0,engine_root_window_.isInArray)(trailMode, events.onHover.mode);
  }
