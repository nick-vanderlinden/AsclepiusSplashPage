...
import populatedNodes from '../Assets/populatedNodes.png';
import cloudDemo from '../Assets/cloudDemo.gif';
import podDemo from '../Assets/podDemo.gif';
      ...
      <div id='content'>
        ...
        <div id='featuresDiv'>
          ...
          <div class='feature-item'>
            <img src={cloudDemo} alt='Connect Cluster Video' />
            <div>
          ...
          <div class='feature-item'>
            ...
            <img src={populatedNodes} alt='Populated Nodes' />
          </div>
          <div class='feature-item'>
            <img src={podDemo} alt='View Node Pods Video' />
            <div>
              <h2 className='feature-header-text'>Identify Pods</h2>
              <p className='contentText'>
                By clicking on a node, Asclepius provides robust health metrics
                by executing a CLI interaction with kubelet in the backend,
                saving you time and helping you understand load immediately.
              </p>
            </div>
          </div>
        </div>
        ...
        <div id='getStartedDiv'>
          ...
          <p className='contentText' id='getStartedText2'>
            We've also posted a short article on&nbsp;
            <a
              href='https://medium.com/@osasclepius/introducing-asclepius-fbe705188af0'
              target='_blank'
              rel='noopener noreferrer'
              style={{ color: '#00BFFF' }}
            >
